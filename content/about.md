...
This is a static website built with [Hugo](https://gohugo.io/), using nothing but HTML, CSS, and a little client-side JavaScript. It's hosted on [Netlify](https://www.netlify.com/) for fast loading and a world-wide CDN.
